...
if __name__ == "__main__":
    ...
    study = optimizer.optimize(
        n_trials=50,
        save_path='best_study_01_hb.pkl',
    ...
    model, predictions = optimizer.train_final_model(
        study,
        model_save_path='data/output/final_model_01_hb.h5',
        history_save_path='data/output/history_01_hb.pkl'
    )
    ...
    predictions.to_csv("data/output/predictions_01_hn.csv", index=False)
    print("HUBBER ==")
