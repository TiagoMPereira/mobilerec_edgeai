...
if __name__ == "__main__":
    ...
    model_data = pd.read_csv("data/output/model_data_01_pca.csv")
    test_data  = pd.read_csv("data/output/test_data_01_pca.csv", index_col=0)
    ...
    neg_df.to_csv("data/output/neg_sample_test_01_pca.csv")
    print("\nSalvo em data/output/neg_sample_test_01_pca.csv")
